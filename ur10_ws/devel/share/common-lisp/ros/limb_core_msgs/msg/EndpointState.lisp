...
(cl:defmethod cl:initialize-instance :after ((m <EndpointState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name limb_core_msgs-msg:<EndpointState> is deprecated: use limb_core_msgs-msg:EndpointState instead.")))
...
(cl:defmethod twist-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader limb_core_msgs-msg:twist-val is deprecated.  Use limb_core_msgs-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'wrench-val :lambda-list '(m))
(cl:defmethod wrench-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader limb_core_msgs-msg:wrench-val is deprecated.  Use limb_core_msgs-msg:wrench instead.")
  (wrench m))
