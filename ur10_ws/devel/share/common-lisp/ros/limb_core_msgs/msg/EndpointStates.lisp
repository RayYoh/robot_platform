...
(cl:defclass <EndpointStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector limb_core_msgs-msg:EndpointState)
   :initform (cl:make-array 0 :element-type 'limb_core_msgs-msg:EndpointState :initial-element (cl:make-instance 'limb_core_msgs-msg:EndpointState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EndpointStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name limb_core_msgs-msg:<EndpointStates> is deprecated: use limb_core_msgs-msg:EndpointStates instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <EndpointStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader limb_core_msgs-msg:names-val is deprecated.  Use limb_core_msgs-msg:names instead.")
  (names m))

(cl:ensure-generic-function 'states-val :lambda-list '(m))
(cl:defmethod states-val ((m <EndpointStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader limb_core_msgs-msg:states-val is deprecated.  Use limb_core_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EndpointStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'limb_core_msgs-msg:EndpointState))
