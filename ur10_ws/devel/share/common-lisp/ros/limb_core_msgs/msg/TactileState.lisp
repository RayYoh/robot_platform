...
(cl:defmethod cl:initialize-instance :after ((m <TactileState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TactileState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name limb_core_msgs-msg:<TactileState> is deprecated: use limb_core_msgs-msg:TactileState instead.")))
...
(cl:defmethod id-val ((m <TactileState>))
...
(cl:defmethod data-val ((m <TactileState>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TactileState>)))
  ...
  "797713ea0a754f9be5b979bbc0cedb1f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TactileState)))
  "Returns md5sum for a message object of type 'TactileState"
  "797713ea0a754f9be5b979bbc0cedb1f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TactileState>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%string[] id~%float64[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TactileState)))
  "Returns full string definition for message of type 'TactileState"
  (cl:format cl:nil "std_msgs/Header header~%string[] id~%float64[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
