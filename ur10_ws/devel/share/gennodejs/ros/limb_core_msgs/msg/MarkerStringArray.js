...
class MarkerStringArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MarkerStringArray(null);
  ...
  static datatype() {
    ...
    return 'limb_core_msgs/MarkerStringArray';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MarkerStringArray(null);
...
module.exports = MarkerStringArray;
